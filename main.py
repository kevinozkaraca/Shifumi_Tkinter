...
def choixCPUcompare():
    ...
    if choixCPU != 5:
        image_CPUchoix = tkinter.Label(fenetre, 
                                       image=image_CPU[choixCPU])
