...
def choixCPUcompare():
    ...
    if choixCPU == choixDuJoueur :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[3], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[3], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[3], bd=5, width=taille_images,height=taille_images,command=bouton2)
    ...
    if choixCPU == 0 and choixDuJoueur == 1 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[0], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[1], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[0], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
        boutonFeuille.place(x=520, y=255)
    if choixCPU == 0 and choixDuJoueur == 2 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[0], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[0], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[2], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
        boutonFeuille.place(x=520, y=255)
    if choixCPU == 1 and choixDuJoueur == 2 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[0], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[0], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[1], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
        boutonFeuille.place(x=520, y=255)
    if choixCPU == 1 and choixDuJoueur == 0 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[2], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[0], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[0], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
    ...
    if choixCPU == 2 and choixDuJoueur == 0 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[1], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[0], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[0], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
    ...
    if choixCPU == 2 and choixDuJoueur == 1 :
        boutonCiseaux = tkinter.Button(fenetre, image=image_ciseaux[0], bd=5, width=taille_images, height=taille_images,command=bouton0)
        boutonFeuille = tkinter.Button(fenetre, image=image_feuille[2], bd=5,width=taille_images, height=taille_images,command=bouton1)
        boutonPierre = tkinter.Button(fenetre, image=image_pierre[0], bd=5, width=taille_images,height=taille_images,command=bouton2)
        boutonCiseaux.place(x=80, y=255)
        boutonPierre.place(x=300, y=255)
        boutonFeuille.place(x=520, y=255)
